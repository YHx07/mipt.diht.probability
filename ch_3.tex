\section{Глава 3. Матожидание и дисперсия.}
...
\end{consequence}
\begin{consequence}[2]
    Пусть  $\xi$~--- абсолютно непрерывная случайная величина с плотностью $p_\xi(x)$, тогда $d F_\xi (x) = p_\xi (x) \, dx$, следовательно $\E g(\xi) = \int\limits_{\R} g(x) p_\xi(x) \, d x$.
\end{consequence}
...
\begin{theorem}[Фубини][б/д]
	...
	\begin{enumerate}
	    ...
	    \item $\xi : \Omega \rightarrow \R$ 
	    такая, что $\int\limits_{\Omega} \big| \xi (\omega_1, \omega_2) \big| d \P < + \infty$.
	\end{enumerate}
