...
\begin{definition}
	Пусть $\xi = \xi(\omega)$~--- случайная величина (вектор) на $\big(\Omega, \F, \P\big)$, тогда $\sigma$-алгеброй $\F_\xi$, порожденной случайной величиной $\xi$, называется $\F_\xi = \big\{\omega: \xi(B), B \in \B(\R)\ (\B(\R^n)) \big\}$.
\end{definition}
