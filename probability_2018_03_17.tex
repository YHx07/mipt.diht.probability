...
\begin{consequence}
	...
	\begin{enumerate}
	    ...
	    \item $\E \xi_n = a$.
	\end{enumerate} 
	Тогда $\dfrac{S_n}{n} \xrightarrow{\P} a$ при $n \rightarrow + \infty$. 
	
	То же самое: $\forall \varepsilon > 0 \hookrightarrow \P \left(\left| \dfrac{S_n}{n} - a \right| > \varepsilon\right) \rightarrow 0$ при $n \rightarrow +\infty$.	
\end{consequence}
